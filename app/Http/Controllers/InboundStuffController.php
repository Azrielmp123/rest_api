...
class InboundStuffController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
          ...
          if ($inboundData) {
            ...
            return ApiFormatter
            ::sendResponse(200, 'success', $stuffWithInboundAndStock);

          }
        } catch (\Exception $err) {
            return ApiFormatter
            ::sendResponse( 400,'bad request', $err->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            if ($minusTotalStock) {
                ...
                $inboundData->delete();
                return ApiFormatter
                ::sendResponse(200, 'succes', $updatedStuffwhithInboundAndStock);
            }
        } catch (\Exception $err) {
            return ApiFormatter
            ::sendResponse(400, 'bad request', $err->getMessage());
    ...
    public function restore(InboundStuff $inboundStuff, $id)
    {
        try {
            ...
            if ($checkProses) {
                ...
                return ApiFormatter
                ::sendResponse(200, 'success', $restoredData);
            } else {
                return ApiFormatter
                ::sendResponse(400, 'bad request', 'Gagal mengembalikan data!');
            }
        } catch (\Exception $err) {
            return ApiFormatter
            ::sendResponse(400, 'bad request', $err->getMessage());
    ...
    public function deletePermanent(InboundStuff $inboundStuff, Request $request, $id)
    {
        try {
            ...
            return ApiFormatter
            ::sendResponse(200, 'success', 'Data inbound-stuff berhasil dihapus permanen');
        } catch(\Exception $err) {
